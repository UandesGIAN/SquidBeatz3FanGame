...
if (global.new_song_name == "" && global.new_song_id == undefined) {
	if (obj_play.play_music && array_length(global.song_visualizer[global.current_chart_index]) > 0 && current_col < array_length(global.song_visualizer[global.current_chart_index]) && obj_sync.current_life > 0) {
